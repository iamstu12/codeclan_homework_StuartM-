...
ggplot(backpack) +
  geom_bar(aes(x = body_weight, y = backpack_weight, fill = sex), stat = "identity") +
  facet_wrap(~ sex)

```

From the graph, you can see that as the body weight in females reaches 150 and 170 for males, the backpack weight count reaches it's maximum.
...
The graph above shows there are more males who do not experience back pain.
